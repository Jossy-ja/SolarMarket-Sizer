...
scenarios (80% / 100% / 120% of the base assumptions) are generated for
later sensitivity analysis via `apply_demand_scenario()`.
...
6. Fill in the notebook's closing **Summary** cell with your own findings
